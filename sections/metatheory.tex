...
The intuition of restricting recursion on smaller-sized arguments is not so
simple to capture set-theoretically.
In the model, we interpret terms and types as their natural set-theoretic
counterparts and size expressions as ordinals;
...
\end{align*}
This expresses \emph{size irrelevance}: size variables bound by fixpoints
merely restrict their domains and do not affect their computation.
