...
% global (Definition vernac), local (let expressions)
% type aliases, so to speak, and necessity of size polymorphism
% size variables need to appear in bodies
% inference algorithm needs constraints and solving
