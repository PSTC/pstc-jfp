...
However, contemporary proof assistants, such as Coq, rely on fragile syntactic criteria that prevent users from easily writing obviously terminating or productive functions, such as quicksort.
