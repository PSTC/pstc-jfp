...
However, being syntactic, these checks are inherently delicate and restrictive,
...
It extends past work on sized types in CIC with additional Coq features such as definitions.
...
We conclude that if we wish to sustain backward compatibility,
