...
This situation is particularly unfortunate, as the Agda programmer is aware, given that there exists a non-syntactic termination and productivity condition which solves essentially all of these problems, whose theory has existed for almost as long, perhaps longer, than the guard condition---\emph{sized types}!
