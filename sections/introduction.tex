...
The acceptance of \coqinline{div} then depends a separate definition independent of \coqinline{div}.
...
does not affect the type of \coqinline{minus} or the typeability of \coqinline{div}.
