...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    This follows from \refrule{var-def} if we can show the following hold:
    \begin{itemize}
      \item $\rho' \Gamma_{\Psi} \equiv \rho'\Gamma_{\Psi_1}(\defn{x}{t}{e})\rho'\Gamma_{\Psi_2}$; and
      \item $\Gamma_G, \rho' \Gamma_{\Psi_1} \vdash \rho' (\rho e) : \rho' (\rho t)$.
    \end{itemize}
    The first is trivial by definition of applying size substitutions to environments.
    ...
    \todo: What about well-formedness of the environments? I think I need to add their inference as premises.
    ...
    Then by \refrule{const-def}, we have our goal.
    \todo: What about well-formedness of the environments? I think I need to add their inference as premises.
