...
\todo: Figure out the correct statement of completeness and whether we want to keep it.
...
Note that since type annotations need to be bare (to maintain subject reduction),
