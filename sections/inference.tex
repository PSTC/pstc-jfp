...
% TODO: Redo this paragraph after establishing that subtyping constraints judgement.
...
\begin{proof}[{[Sketch]}]
By induction on the rules for constraints induced by subtyping in \autoref{fig:algorithm-subtyping}.
\end{proof}
