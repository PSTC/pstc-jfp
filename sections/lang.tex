...
and convertibility ($\approx$) in \autoref{fig:convertibility}.
For brevity, we state congruence rules using substitution,
and refer the reader to previous work~\citep{cic-hat-minus, cic-hat, cc-hat-omega} and the Coq manual in particular~\citep{coq} for precise details and definitions.
