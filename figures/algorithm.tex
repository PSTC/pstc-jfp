...
\begin{flushleft}
\fbox{$\cgp \vdash e^\circ \rightsquigarrow C, e \Rightarrow t$}
\end{flushleft}
...
\inferrule[\defrule{a-var-assum}]{
    ...
    \cgp \vdash x \rightsquigarrow C, x \Rightarrow t
}
...
\inferrule[\defrule{a-case}]{
    ...
    \Gamma_G, \Gamma_{\Psi} \vdash t_p \constrain \motivetype{\Sigma}{\overline{p}}{U}{I_k^{\hat{\upsilon}}} \rightsquigarrow C_4 \\
...
\inferrule[\defrule{a-fix}]{
    ...
    \Gamma_G, \Gamma_{\Psi} \Delta_k \vdash u_k \constrain u'_k \rightsquigarrow C_3 \and
    C_4 = \textstyle\bigcup_k C_{2k} \cup C_3 \and
    C_5 = \RecCheckLoop{C_4}{\overline{\getrecvar{t_k}{n_k}}}{\overline{t_k}}{\overline{e_k}}
}{
    \cgp \vdash \fix{m}{f_k^{n_k}}{t_k^\circ}{e_k^\circ} \rightsquigarrow C_3, \fix{m}{f_k^{n_k}}{|t_k|^*}{e_k} \Rightarrow t_m
}
...
\inferrule[\defrule{a-cofix}]{
    ...
    \prodctx{\Delta_k}{u_k} = \whnf{t_k} \and \prodctx{\Delta'_k}{u'_k} = \shift{\prodctx{\Delta_k}{u_k}} \and
    \textstyle\bigcup_k C_{1k}, \Gamma_G, \Psi\overline{(f_k : t_k)} \vdash e_k^\circ \Leftarrow \prodctx{\Delta'_k}{u'_k} \rightsquigarrow C_{2k}, e_k \\
    \Gamma_G, \Gamma_{\Psi} \vdash \Delta'_k \constrain \Delta_k \rightsquigarrow C_{3k} \and
    C_4 = \textstyle\bigcup_k C_{2k} \cup C_{3k} \and
